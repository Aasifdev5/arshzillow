  ...
  <Box>
    ...
    <form @submit.prevent="upload">
      <section class="flex items-center gap-2 my-4">
        <input
          class="border rounded-md file:px-4 file:py-2 border-gray-200 dark:border-gray-700 file:text-gray-700 file:dark:text-gray-400 file:border-0 file:dark:gray-800 file:font-medium file:hover:bg-gray-200"
          type="file"
          multiple
          @input="addFiles"
        />
...
// Start NProgress when the request starts
Inertia.on("start", () => {
  NProgress.start();
});
