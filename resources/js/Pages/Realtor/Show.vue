<template>
  ...
  <section class="flex flex-col-reverse md:grid-cols-12 gap-4">
...
<Offer v-for="offer in listing.offers" :key="offer.id" :offer="offer" :listing-price="listing.price" :is-sold="listing.sold_at != null"></Offer>
    </div>
