    ...
    <header class="w-full border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
      <div class="container mx-auto">
        <nav class="p-4 flex items-center justify-between">
          ...
          <div class="flex items-center text-indigo-600 dark:text-indigo-300 font-bold text-center">
          ...
          <div class="flex items-center gap-4">
            <div v-if="user" class="flex items-center">
              ...
              <Link :href="route('logout')" method="DELETE" as="button" class="btn-primary mx-3">Logout</Link>
            </div>
